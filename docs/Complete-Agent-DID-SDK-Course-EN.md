...
| 4 | "Does it work with LangChain/CrewAI?" | Yes. The LangChain integration is already implemented in [../integrations/langchain/README.md](../integrations/langchain/README.md), CrewAI now has a functional Python integration in [../integrations/crewai/README.md](../integrations/crewai/README.md), and Semantic Kernel now has a functional Python integration in [../integrations/semantic-kernel/README.md](../integrations/semantic-kernel/README.md). The SDK remains framework-agnostic. Microsoft Agent Framework remains a separate future integration target. |
