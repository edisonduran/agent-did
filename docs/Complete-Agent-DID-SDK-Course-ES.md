...
| 4 | "¿Funciona con LangChain/CrewAI?" | Sí. La integración con LangChain ya está implementada en [../integrations/langchain/README.md](../integrations/langchain/README.md), CrewAI ya tiene una integración Python funcional en [../integrations/crewai/README.md](../integrations/crewai/README.md), y Semantic Kernel ya tiene una integración Python funcional en [../integrations/semantic-kernel/README.md](../integrations/semantic-kernel/README.md). El SDK sigue siendo framework-agnostic. Microsoft Agent Framework queda como integración futura separada. |
